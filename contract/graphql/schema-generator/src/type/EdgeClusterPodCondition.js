...
import EdgeClusterPodConditionType from './EdgeClusterPodConditionType';
import EdgeClusterNodeConditionStatus from './EdgeClusterNodeConditionStatus';

export default new GraphQLObjectType({
	name: 'EdgeClusterPodCondition',
	description: ' Current service state of pod',
	fields: {
		type: { type: new GraphQLNonNull(EdgeClusterPodConditionType), description: 'Type of pod condition' },
