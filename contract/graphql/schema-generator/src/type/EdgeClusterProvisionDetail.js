...
export default new GraphQLObjectType({
	...
	fields: {
		ingress: {
			type: new GraphQLNonNull(new GraphQLList(new GraphQLNonNull(Ingress))),
			description: 'The ingress details of the edge cluster master node',
		},
		ports: {
			type: new GraphQLNonNull(new GraphQLList(new GraphQLNonNull(Port))),
			description: 'The ingress details of the edge cluster master node',
		},
		kubeconfigContent: {
			type: GraphQLString,
