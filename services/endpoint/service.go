...
func NewEndpointCreatorService(
	...
	if err != nil {
		return nil, commonErrors.NewUnknownErrorWithError("Failed to find schema.graphql", err)
	}
	...
	if err != nil {
		return nil, commonErrors.NewUnknownErrorWithError("Failed to create the root resolver", err)
	}
